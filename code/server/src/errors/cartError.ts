...
/**
 * Return a 422 error when the product is not provided or is an empty string.
 */
...
export { CartNotFoundError, ProductInCartError, ProductNotInCartError, WrongUserCartError, EmptyCartError, UnprocessableEntity }
...
//const EMPTY_PARAMETER = "Empty parameter"; const DATE_NOT_IN_PAST = "Date not in the past";
...
class EmptyParameter extends Error {customMessage: String; customCode: Number;constructor() {super(), /*this.customMessage = EMPTY_PARAMETER,*/ this.customCode = 422}}
class DateNotInThePast extends Error {customMessage: String; customCode: Number;constructor() {super(), /*this.customMessage = DATE_NOT_IN_PAST,*/ this.customCode = 400}}
...
export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, EmptyParameter, DateNotInThePast }